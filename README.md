...
- If you are using MacOS, you will get a warning, click "cancel". Then go to your computers system preferences. Open security and privacy. Then general. You will see a notification about muscle, click "allow anyway". 
