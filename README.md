...
(click the link and download the newest version for your computer). In order to use Muscle, we must first change the computers permissions and allow the use of Muscle.
